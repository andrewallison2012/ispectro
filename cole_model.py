...
def generate_regression(data):
    ...
    x_m = (Rzero + Rinf) * 0.5
    y_m = (Rzero - Rinf) * 0.5 * cos(a*pi * 0.5) * (sin(a*pi*0.5))**-1
    # y_m = (Rzero - Rinf) * 0.5 * cos(a * pi * 0.5) * (sin(a * pi * 0.5))
    x_m = mean(x)
    y_m = mean(y)
    ...
    p.text(Rzero - R_2.round(1)*.1, 0,stringoutput, horizontalalignment='right', verticalalignment='top')
...
# generate_regression('/home/ala/PycharmProjects/impedance_spectroscopy/data/calibrated-data-2021-05-11_12:59:37.csv')
